"""High-level helper for geoProcessing:delete tasks using an EQL query as the source."""
...
def delete_from_layer_via_eql(
    ...
    *,
    ...
    """Delete features from an EverGIS layer based on an EQL query.

    Args:
        client: Initialised EverGIS API client instance.
        eql: EQL query that defines the delete source dataset.
        target_layer: Name of the layer that will be updated.
        target_layer_alias: Optional alias for the target layer recorded in task settings.
    ...
    start_params = GeoprocessingDeleteStartParameters(
