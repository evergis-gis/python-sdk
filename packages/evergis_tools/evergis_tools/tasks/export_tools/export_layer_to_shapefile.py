"""High-level export of EverGIS layer to Shapefile format."""
...
def export_layer_to_shapefile(
    ...
    *,
    ...
    """Export EverGIS layer to Shapefile format via ImportExport task.
    ...
    Shapefile is a geospatial vector data format that natively supports geometry,
    ...
    Args:
        ...
        target_file_name: Resource ID or catalog path for target Shapefile.
        ...
        target_layer_name: Name of the layer within the Shapefile (optional).
    ...
    Example:
        ...
        ...     client=client,
        ...     source_layer="john_doe.my_layer",
        ...     source_eql="SELECT * FROM john_doe.my_layer WHERE area > 1000",
        ...     target_file_name="filtered_export.shp",
        ...     target_parent_path="john_doe:Projects/Exports",
        ...     target_layer_name="filtered_data"
        ... )
        ...
        >>> result = export_layer_to_shapefile(
        ...     client=client,
        ...     source_layer="john_doe.buildings",
        ...     target_file_name="buildings_export.shp",
    ...
    start_params = LayerToShapeStartParameters(
